...
- (void)prepare
{
    ...
    //设置开启下拉带动画刷新
    self.headerRefreshingUseAnimation = YES;
}
...
- (void)headerEndingAction {
    ...
    [UIView animateWithDuration:MJRefreshSlowAnimationDuration animations:^{
       self.scrollView.mj_insetT = self.scrollView.mj_insetT + self.insetTDelta + self.finishRefreshInsetTop;
...
- (void)headerRefreshingAction {
    ...
    //不使用动画刷新
    if (!self.headerRefreshingUseAnimation) {
